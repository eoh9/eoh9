...
BETA_DATABASE = {
    ...
    # 전자 부품 (5개)
    "capacitor": {"beta": 2.8, "source": "Component Database", "confidence": "medium"},
...
**핵심 기술적 성과:**
- 100만+ 행 대용량 데이터 처리 (청킹 전략)
- Excel MCP 기반 전문 리포트 자동 생성
- **자동 신뢰성 테스트 계산 및 Test Time 도출**
- **다중 소스 베타 값 검색 (DB + OpenAI + 웹)**
- **Weibull 분포 적합도 검정 및 신뢰도 곡선 자동 생성**
- 실시간 진행상황 추적 및 비동기 처리
- AI 기반 베타 값 검색 및 데이터 품질 진단
- 메모리 최적화 및 성능 모니터링
